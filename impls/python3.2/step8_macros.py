                    ...
                    match first_symbol.value:
                        case "def!" | "defmacro!":
                            ...
                            if isinstance(value, MalFunction):
                                ...
                                value.is_macro = first_symbol.value == "defmacro!"
                        ...
                        case 'quasiquote':
                            ...
                            continue
                evalutated_first_item = EVAL(l.elements[0], env)
                if isinstance(evalutated_first_item, MalNil):
                    return MalList(evaluated_items, l.start, l.end)
                match evalutated_first_item:
                    ...
                    case _:
                        raise MalSyntaxError(f"First element of list is not a function: {pr_str(evalutated_first_item, True)}", l.start)
            case MalVector() as v:
                if v.size == 0:
                    return v
